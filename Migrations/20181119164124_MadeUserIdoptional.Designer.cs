...
namespace QuickleeBackEnd.Migrations
{
    ...
    [Migration("20181119164124_MadeUserIdoptional")]
            ...
            modelBuilder.Entity("QuickleeBackEnd.Models.Reports", b =>
                {
                    ...
                    b.Property<int>("InventoriesIdBegin");

                    b.Property<int>("InventoriesIdEnd");
                    ...
                    b.HasData(
                        new { Id = -1, InventoriesIdBegin = -1, InventoriesIdEnd = -2, Purchases = 100.01f, ReportDate = new DateTime(2018, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Sales = 500.01f }
                    );
                });
