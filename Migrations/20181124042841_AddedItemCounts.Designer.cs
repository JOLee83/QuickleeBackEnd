...
namespace QuickleeBackEnd.Migrations
{
    ...
    [Migration("20181124042841_AddedItemCounts")]
    partial class AddedItemCounts
    {
            ...
            modelBuilder.Entity("QuickleeBackEnd.Models.Items", b =>
                {
                    ...
                    b.HasData(
                        new { Id = -1, Count = 0f, ItemName = "Item A", ItemPrice = 1.99f, UsersId = -1 },
                        new { Id = -2, Count = 0f, ItemName = "Item B", ItemPrice = 2.99f, UsersId = -1 },
                        new { Id = -3, Count = 0f, ItemName = "Item C", ItemPrice = 3.99f, UsersId = -1 }
                    );
                });
